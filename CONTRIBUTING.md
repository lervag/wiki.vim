...
This plugin is developed mainly through the master branch, and pull requests
should be [fork based](https://help.github.com/articles/using-pull-requests/).
...
The documentation style should be relatively clear, and it should be
...
When submitting code, please adhere to the following standards:
