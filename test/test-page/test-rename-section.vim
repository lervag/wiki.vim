...
call cursor(3, 1)
silent call wiki#page#rename_section_to('Subsection i')

call cursor(6, 1)
silent call wiki#page#rename_section_to('Subsection ii')

call cursor(7, 1)
silent call wiki#page#rename_section_to('Section II')

" This doessn't work because of issues with the graph
" call cursor(11, 1)
" call wiki#page#rename_section_to('New sub section')
