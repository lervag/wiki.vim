...
# ///
"""Render doc/wiki.txt to a standalone HTML page under <outdir>.
...
DOC_SRC = REPO_ROOT / "doc" / "wiki.txt"
...
<title>wiki.vim documentation</title>
<meta name="description" content="Documentation for wiki.vim, a Vim/Neovim plugin for writing and maintaining a personal wiki.">
...
def strip_frontmatter_and_links(fragment: str) -> str:
    ...
    return body.replace('href="/doc/user/wiki/#', 'href="#')
